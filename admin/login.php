...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM user WHERE username = '$username' AND password = '$password' AND is_archived='0'";
...
//         $query = "SELECT employee_id, username, is_archived FROM employees 
...
//                 header('location: login.php?error=account_archived');
//                 exit();
//             }
