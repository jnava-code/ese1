    ...
    <body>
        <main class="main-content">
                ...
                <div class="file_content">
                        ...
                        $file_path = "../files/" . $employee['others'];
                        $file_type = $employee['others_type'];

                        if (!empty($employee['others']) && file_exists($file_path)) {
                            // Check file type
                            if (strpos($file_type, 'image/') === 0) {
                                echo '<img src="' . $file_path . '" alt="Employee Others File" />';
