    ...
    <body>
        <main class="main-content">
                ...
                <div class="file_content">
                        ...
                        $file_path = "../files/" . $employee['nbi_clearance'];
                        $file_type = $employee['police_type'];

                        if (!empty($employee['nbi_clearance']) && file_exists($file_path)) {
                            // Check file type
                            if (strpos($file_type, 'image/') === 0) {
                                echo '<img src="' . $file_path . '" alt="Employee NBI Clearance File" />';
