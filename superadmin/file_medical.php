    ...
    <body>
        <main class="main-content">
                ...
                <div class="file_content">
                        ...
                        $file_path = "../files/" . $employee['medical'];
                        $file_type = $employee['medical_type'];

                        if (!empty($employee['medical']) && file_exists($file_path)) {
                            // Check file type
                            if (strpos($file_type, 'image/') === 0) {
                                echo '<img src="' . $file_path . '" alt="Employee Medical File" />';
