...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 06, 2025 at 10:00 AM
...
(4, 'admin', '$2y$10$30kJpHW0K6n2GqVM7YMBwuyjtIvCWThJmCGhyObUOpEtR3VPhr.GC', 1, 1, 'John', 'mark', 'dccsamaniego@bpsu.edu.ph', '909233422131');
...
CREATE TABLE `employees` (
  ...
  `medical` mediumblob DEFAULT NULL,
  `tor` mediumblob DEFAULT NULL,
  `nbi_clearance` mediumblob DEFAULT NULL,
  `resume` mediumblob DEFAULT NULL,
  `prc` mediumblob DEFAULT NULL,
  `others` mediumblob DEFAULT NULL,
...
INSERT INTO `employees` (`id`, `last_name`, `first_name`, `middle_name`, `suffix`, `email`, `position`, `hire_date`, `department`, `employment_status`, `employee_id`, `user_type`, `password`, `e_status`, `date_of_birth`, `contact_number`, `perma_address`, `civil_status`, `sss_number`, `philhealth_number`, `pagibig_number`, `tin_number`, `emergency_contact_name`, `emergency_contact_number`, `educational_background`, `skills`, `username`, `sick_leave`, `vacation_leave`, `maternity_leave`, `paternity_leave`, `medical`, `tor`, `nbi_clearance`, `resume`, `prc`, `others`, `is_archived`) VALUES
(2, 'capulong', 'cristina', 'adona', '', 'admin123@gmail.com', 'Field Track', '2024-12-21', 'Sales', 'Active', 12345, 2, '09ca6ec0b133', 1, '2024-12-18', '09093556311', '010#/lower tundol/reformista', 'Married', '43-3453468-6', '21-432432342-2', '1246-3243-4235', '876-456-235-423', 'cristina adona capulong', '0965965965', 'High School Graduate', 'sql', 'Akali1423', 0, 0, 0, 0, '', '', '', '', '', '', 0);
...
(21, 12345, 1, '2024-12-27', '{\"job_knowledge\":\"2\",\"quality_of_work\":\"3\",\"work_ethic\":\"3\",\"communication_skills\":\"4\",\"punctuality\":\"2\",\"goals_achievements\":\"3\"}', 'nice', 'Effective', 2.83, 'Completed'),
(22, 12345, 1, '2024-12-27', '{\"job_knowledge\":\"2\",\"quality_of_work\":\"3\",\"work_ethic\":\"3\",\"communication_skills\":\"4\",\"punctuality\":\"2\",\"goals_achievements\":\"3\"}', 'nice', 'Effective', 2.83, 'Completed'),
(23, 12345, 1, '2024-12-27', '{\"job_knowledge\":\"1\",\"quality_of_work\":\"1\",\"work_ethic\":\"1\",\"communication_skills\":\"1\",\"punctuality\":\"1\",\"goals_achievements\":\"1\"}', 'eyy', 'Need Guidance', 1.00, 'Completed'),
(24, 12345, 1, '2024-12-27', '{\"job_knowledge\":\"1\",\"quality_of_work\":\"1\",\"work_ethic\":\"1\",\"communication_skills\":\"1\",\"punctuality\":\"1\",\"goals_achievements\":\"1\"}', 'asdasdas', 'Need Guidance', 1.00, 'Completed');
